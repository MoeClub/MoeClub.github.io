...
wget --no-check-certificate -qO "/tmp/shadowsocks-libev_2.4.6-1_${arch}.deb" "https://moeclub.org/attachment/LinuxShell/libev/shadowsocks-libev_2.4.6-1_${arch}.deb"
